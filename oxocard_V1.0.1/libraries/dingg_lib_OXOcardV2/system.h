...
class System{
	public:
		...
		#ifdef CONFIG_SLEEP_BUTTON_BYTE
			static const uint8_t DEFAULT_TURN_OFF_BUTTON_BYTE = CONFIG_SLEEP_BUTTON_BYTE;
		#else
			static const uint8_t DEFAULT_TURN_OFF_BUTTON_BYTE = 0b00111111;
		#endif
	...
	private:
		...
		static wakeUpCause_t wakeUpCause;
